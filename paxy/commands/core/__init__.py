...
from paxy.commands.core.convert import ToFloat, ToInt, ToStr
...
from paxy.commands.core.isbop import IsCommand, IsNotCommand
from paxy.commands.core.label import GotoCommand, LabelCommand
